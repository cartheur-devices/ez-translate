...
namespace MobileTranslation.Messaging
{
    /// <summary>
    /// A message superclass, all message classes must derive from this one.
    /// </summary>
    public class Message
    {
        ...
        /// <summary>
        /// Converts a time span to unix time.
        /// </summary>
        /// <param name="dateTime">takes DateTime.</param>
