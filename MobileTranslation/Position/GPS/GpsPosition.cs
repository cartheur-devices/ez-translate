...
namespace MobileTranslation.GPS
{
    ...
    /// <summary>
    /// Base class to handle GPS satellite availability and count.
    /// </summary>
    public class Satellite
    {
        ...
        int signalStrength;
        /// <summary>
        /// Signal Strenth of the satellite.
        /// </summary>
    ...
    /// <summary>
    /// This class tries to acquire a GPS fix in the device.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public class GpsPosition
    {
        ...
        // Which fields are valid depend on GPS device being used, how stale the API allows the data to be, and current signal.
        // Valid fields are specified in dwValidFields, based on GPS_VALID_XXX flags.
        internal int dwValidFields = 1;
        ...
        /// <summary>
        /// UTC according to the GPS clock.
        /// </summary>
